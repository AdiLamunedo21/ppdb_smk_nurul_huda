...
$(document).ready(function () {
    ...
    if (
        typeof filter_nama_sekolah !== "undefined" &&
        filter_nama_sekolah !== null
    ) {
...

            {
                ...
                render: function (data) {
                    let btn =
                        '<a href="/peserta/edit/' +
                        data.peserta_id +
                        '" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a> <a href="https://wa.me/' +
                        data.no_wa +
                        '" class="btn btn-sm btn-success ml-2" target="_blank"><i class="fab fa-whatsapp"></i></a>';
                    btn +=
                        '<button type="button" class="btn btn-sm btn-danger ml-2 btn-delete" data-id="' +
                        data.peserta_id +
                        '" data-name="' +
                        data.nama_lengkap +
                        '" onclick="delete_peserta(this);"><i class="fa fa-trash"></i></a>';
                    return btn;
                },
            },
        ],
    ...
    $("#berkasIjazahTable").DataTable({
        ...
        columns: [
            ...
            {
                data: "peserta.created_at",
                name: "peserta.created_at",
                render: function (data) {
            ...
            },
            {
                ...
                render: function (data) {
                    var prosesSelected =
                        data.status_konfirmasi == "proses" ? "selected" : "";
                    var diterimaSelected =
                        data.status_konfirmasi == "diterima" ? "selected" : "";
                    var ditolakSelected =
                        data.status_konfirmasi == "ditolak" ? "selected" : "";

                    var token = $('meta[name="csrf-token"]').attr("content");

                    var elem =
                        '<form action="/status-konfirm-ijazah" method="post">';
                    elem +=
                        '<select class="form-control form-control-sm" name="status_konfirmasi" onchange="this.form.submit()">';
                    elem +=
                        "<option " +
                        prosesSelected +
                        ' value="proses">-- Pilih --</option>';
                    elem +=
                        "<option " +
                        diterimaSelected +
                    ...
                    elem += "</select>";
                    elem +=
                        '<input type="hidden" name="ijazah_id" value="' +
                        data.ijazah_id +
                        '">';
                    elem +=
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data) {
                    ...
                    var elem =
                        '<form action="/status-konfirm-sk-lulus" method="post">';
                    elem +=
                        '<select class="form-control form-control-sm" name="status_konfirmasi" onchange="this.form.submit()">';
                    elem +=
                        "<option " +
                    ...
                    elem += "</select>";
                    elem +=
                        '<input type="hidden" name="sk_lulus_id" value="' +
                        data.sk_lulus_id +
                        '">';
                    elem +=
                        '<input type="hidden" name="_token" value="' +
    ...
    $("#pesertaLulusTable").DataTable({
        ...
        serverSide: true,
        ajax:
            "/peserta-lulus/json?filter=0" +
            filter_peserta_lulus +
            filter_tahun_daftar +
            filter_gelombang_id,
        columns: [
            { data: "no_pendaftaran", name: "no_pendaftaran" },
            ...
            { data: "jurusan.nama", name: "jurusan.nama" },
            {
                ...
                render: function (data) {
                    ...
                    if (data == "lulus") {
                        str =
                            '<label class="badge badge-success" style="font-size: 11px;">Lulus</label>';
                    } else {
                        str =
                            '<label class="badge badge-warning" style="font-size: 11px;">Belum Daftar</label>';
                    }
            ...
            {
                data: "status_kelulusan_berkas",
                name: "status_kelulusan_berkas",
                render: function (data) {
                    var str;
                    if (data == "lulus") {
                        str =
                            '<label class="badge badge-success" style="font-size: 11px;">Diterima</label>';
                    } else {
                        str =
                            '<label class="badge badge-warning" style="font-size: 11px;">Belum Upload</label>';
                    }
        ...
        columns: [
            ...
            { data: "jurusan.nama", name: "jurusan.nama" },
            {
                ...
                render: function (data) {
                    ...
                    var prosesSelected =
                        data.sudah_lulus == "proses" ? "selected" : "";
                    var diterimaSelected =
                        data.sudah_lulus == "lulus" ? "selected" : "";
                    var ditolakSelected =
                        data.sudah_lulus == "tidak_lulus" ? "selected" : "";

                    var token = $('meta[name="csrf-token"]').attr("content"); // Ambil token CSRF dari meta tag

                    var elem =
                        '<form action="/status-konfirm-daftar-ulang" method="post">';
                    elem +=
                        '<select class="form-control form-control-sm" name="sudah_lulus" onchange="this.form.submit()">';
                    elem +=
                        "<option " +
                        prosesSelected +
                        ' value="proses">-- Pilih --</option>';
                    elem +=
                        "<option " +
                        diterimaSelected +
                        ' value="lulus">Diterima</option>';
                    elem +=
                        "<option " +
                        ditolakSelected +
                        ' value="tidak_lulus">Ditolak</option>';
                    elem += "</select>";
                    elem +=
    ...
    $("#pesertaReferalTable").DataTable({
        ...
        columns: [
            ...
            { data: "asal_sekolah", name: "asal_sekolah" },
            {
                ...
                render: function (data) {
                    ...
                    if (data.pembayaran === null) {
                        ...
                        data.pembayaran.status_konfirmasi == "diterima"
                    ) {
                        badge = "success";
            ...
            {
                data: "pendamping.nama_lengkap",
                name: "pendamping.nama_lengkap",
            },
            {
                data: "pendamping.no_hp",
                name: "pendamping.no_hp",
                orderable: false,
            },
            {
                data: null,
                ...
                render: function (data) {
                    ...
                    if (
                        ...
                        (data.pembayaran != null &&
                            data.pembayaran.status_konfirmasi === "ditolak")
                    )
                        return "-";
                    ...
                    if (data.komisi === null) {
                        ...
                        sudah_diklaim =
                            "<label class='badge badge-dark'>Belum</label>";
                    }
